...
<template>
    <div class="md:order-2">
        <div class="flex items-center">
            ...
            <button type="button"
                ...
                <img class="w-8 h-8 rounded-full"
                    src="https://ui-avatars.com/api/?name=Fakhrian+Ikhwaludin&background=160442&color=fff" alt="user-photo">
            </button>
        </div>
        ...
        <div class="z-50 fixed right-20 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
            ...
            <div class="px-4 py-3">
                <span class="block text-sm text-gray-900 dark:text-white">Fakhrian</span>
                <span class="block text-sm text-gray-500 truncate font-regular dark:text-gray-400">fakhrian@gmail.com</span>
            </div>
